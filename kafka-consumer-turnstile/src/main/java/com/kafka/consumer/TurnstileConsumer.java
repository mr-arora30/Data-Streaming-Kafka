...
import com.kafka.consumer.service.TurnstilService;

import lombok.extern.slf4j.Slf4j;

@Component
@Slf4j
public class TurnstileConsumer {
	@Autowired
	private TurnstilService service;
 ...
 public void onMessage(ConsumerRecord<String, String> consumerRecord) throws JsonMappingException, JsonProcessingException {
	 ...
	 service.processTurnstileEvent(consumerRecord);
